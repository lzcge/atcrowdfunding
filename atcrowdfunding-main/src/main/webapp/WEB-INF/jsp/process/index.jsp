...
<form class="form-inline" role="form" style="float:left;">
  ...
  <button type="button" class="btn btn-warning" onclick="queryCondition()"><i class="glyphicon glyphicon-search"></i> 查询</button>
</form>
	...
	<script src="${APP_PATH }/jquery/jquery-form/jquery-form.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            $("#processDefFile").change(function(){
        		...
        		var options = {
        			...
        			beforeSubmit : function(){
        					loadingIndex = layer.msg('数据正在部署中', {time:2000,icon: 6});
        			...
        			success : function(result){
               			...
               			if(result.info=="success"){
                            ...
                            layer.msg(result.data, {time:2000, icon:5, shift:6});
            ...
            function queryPageUser(pageIndex){
                ...
                if(condition){
                    jsonObj.queryText = $("#queryText").val(); //增加模糊查询条件
                }
            	$.ajax({
            		type : "POST",
            		data : jsonObj,
            		...
            		success : function(result){
            			...
            			if(result.info=="success"){
            				...
            				layer.msg("查询流程定义失败!", {time:1000, icon:5, shift:6});
            			}
            		},
            		error : function(){
