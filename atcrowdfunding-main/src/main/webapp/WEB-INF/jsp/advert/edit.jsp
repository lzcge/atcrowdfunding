    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">人人筹 - 广告维护</a></div>
        </div>
        ...
        <script type="text/javascript">
            ...
            $(function(){
            	$("#updateBtn").click(function(){
                	...
                	var url = $("#url").val();
                	if($.trim(name)==''){
                        layer.msg("广告名称不能为空",{time:2000,icon:0,shift:0},function () {
                            $("#name").val("");
                            $("#name").focus();
                        });
                    }else if($.trim(url)==''){
                        layer.msg("广告地址不能为空",{time:2000,icon:0,shift:0},function () {
                            $("#url").val("");
                            $("#url").focus();
                        });
                    }else{
                        ...
                        $.ajax({
                            ...
                            success : function(result){
                                ...
                                if(result.info=="success"){
                                    layer.msg("广告数据修改成功", {time:2000, icon:6});
                                    setTimeout(2000);
