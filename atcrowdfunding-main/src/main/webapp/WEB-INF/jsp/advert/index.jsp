	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<div>
					<a class="navbar-brand" style="font-size: 32px;" href="#">人人筹 - 广告维护</a>
				</div>
			</div>
            	...
            	$.ajax({
            		...
            		success : function(result){
            			...
            			if(result.info=="success"){
            				...
            				layer.msg("广告分页查询数据失败", {time:2000, icon:5, shift:6});
            				
            			}
            		},
            		error : function(){
            			layer.msg("广告分页查询数据错误", {time:2000, icon:5, shift:6});
            		}
    			...
    			layer.confirm("是否要删除广告?",  {icon: 3, title:'提示'}, function(cindex){
    				...
    				$.ajax({
    					...
    					success : function(result){
    					    console.log(result);
    						if(result.info=="success"){
    							layer.msg("删除"+name+"广告成功!", {time:2000, icon:6}, function(){
    								queryPage(0);
    							});
    						}else{
    							layer.msg("删除"+name+"广告失败!", {time:2000, icon:5, shift:6});
    						}
    					}
    				});
